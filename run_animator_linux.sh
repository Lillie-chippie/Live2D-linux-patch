...
# Live2D Cubism 2.0 Animator Linux Launcher
...
# Construct Classpath
# We use the downloaded Linux-compatible JOGL 2.0-rc11 libraries.
CP=""
...
# Note: QuickTime (QTJava.zip) is excluded as it is not supported on Linux.

# Launch
echo "Starting Live2D Cubism 2.0 Animator on Linux..."
